 ...
 * 枚举通用TypeHandler
 *
 * 配置 enum 默认 TypeHandler
 * mybatis.configuration.default-enum-type-handler=com.example.tk.mybatis.example.support.MybatisEnumTypeHandler
 *
 * 在字段上添加{@link @EnumValue}注解
 * 如果为配置处理，将会使用枚举的name作为值
 *
 * @param <E>
 */
@Slf4j
